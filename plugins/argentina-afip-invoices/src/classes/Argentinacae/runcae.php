...
//Solicito el CAE
if (DEBUG){ echo '<pre>'; print_r($params); echo '</pre>';}
$cae = $wsfev1->solicitarCAE($params,$cuitSolicitante);								

// Lo muestro
if(isset($cae->FECAESolicitarResult->FeCabResp->Resultado)){
if (DEBUG) print_r('Resultado '. $cae->FECAESolicitarResult->FeCabResp->Resultado.'<br>');
...
} else if($cae->FECAESolicitarResult->FeCabResp->Resultado=='R'){
	$caeResult['resultado'] = $cae->FECAESolicitarResult->FeCabResp->Resultado;
...
if (DEBUG){ echo '<pre>'; print_r($cae); echo '</pre>';}


if (DEBUG){ echo '<pre>'; print_r($caeResult); echo '</pre>';}
return $caeResult;
}
