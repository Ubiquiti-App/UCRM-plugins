...
final class Locale
{
    ...
    // TODO: Add additional translation locales as available!

    /**
     * @param string $code The ISO Language Code for which to search.
     * @return string|null Returns the name for the given code if it exists, otherwise NULL.
     */
    public static function name(string $code): ?string
    {
        $codes = [
            ...
            "es-ES"     => "Spanish (Spain)", // "Spanish (Castilian, Spain)",
        ...
        return array_key_exists($code, $codes) ? $codes[$code] : null;
    }
